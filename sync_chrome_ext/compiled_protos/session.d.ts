...
export class SessionService extends $protobuf.rpc.Service {
     ...
     */
    public getUserInfo(request: IGetUserInfoReq, callback: SessionService.getUserInfoCallback): void;
     ...
     * @returns Promise
     */
    public getUserInfo(request: IGetUserInfoReq): Promise<UserInfo>;
...
export namespace SessionService {
     ...
     */
    type getUserInfoCallback = (error: (Error|null), response?: UserInfo) => void;
