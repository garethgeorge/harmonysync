...
$root.SessionService = (function() {
    ...
    /**
     * Callback as used by {@link SessionService#getUserInfo}.
     * @memberof SessionService
     ...
     * @memberof SessionService
     * @instance
     * @param {IGetUserInfoReq} request GetUserInfoReq message or plain object
     * @param {SessionService.getUserInfoCallback} callback Node-style callback called with the error, if any, and UserInfo
     * @returns {undefined}
     * @variation 1
     */
    Object.defineProperty(SessionService.prototype.getUserInfo = function getUserInfo(request, callback) {
        return this.rpcCall(getUserInfo, $root.GetUserInfoReq, $root.UserInfo, request, callback);
     ...
     * @instance
     * @param {IGetUserInfoReq} request GetUserInfoReq message or plain object
     * @returns {Promise<UserInfo>} Promise
     * @variation 2
     */
