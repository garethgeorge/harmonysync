...
$root.ServerSyncService = (function () {
  ...
  (ServerSyncService.prototype = Object.create(
    $protobuf.rpc.Service.prototype
  )).constructor = ServerSyncService;
   ...
   */
  ServerSyncService.create = function create(
    rpcImpl,
    requestDelimited,
    responseDelimited
  ) {
  ...
  Object.defineProperty(
    (ServerSyncService.prototype.getServerVersion = function getServerVersion(
      request,
      callback
    ) {
      return this.rpcCall(
   ...
   */
  Object.defineProperty(
    (ServerSyncService.prototype.setSyncState = function setSyncState(
      request,
      callback
    ) {
      return this.rpcCall(
        setSyncState,
        $root.SetSyncStateReq,
        $root.SetSyncStateResp,
        request,
        callback
      );
    }),
   ...
   */
  Object.defineProperty(
    (ServerSyncService.prototype.requestResync = function requestResync(
      request,
      callback
    ) {
      return this.rpcCall(
        requestResync,
        $root.RequestResyncReq,
        $root.Empty,
        request,
        callback
      );
...
$root.ClientSyncService = (function () {
  ...
  (ClientSyncService.prototype = Object.create(
    $protobuf.rpc.Service.prototype
  )).constructor = ClientSyncService;
   ...
   */
  ClientSyncService.create = function create(
    rpcImpl,
    requestDelimited,
    responseDelimited
  ) {
   ...
   */
  Object.defineProperty(
    (ClientSyncService.prototype.setSyncState = function setSyncState(
      request,
      callback
    ) {
      return this.rpcCall(
...
$root.ServerProtocolVersion = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ServerProtocolVersion.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim();
  ...
  ServerProtocolVersion.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ServerProtocolVersion();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  ServerProtocolVersion.fromObject = function fromObject(object) {
    if (object instanceof $root.ServerProtocolVersion) return object;
...
$root.SyncState = (function () {
  ...
  SyncState.encode = function encode(message, writer) {
    ...
    if (
      message.playing != null &&
      Object.hasOwnProperty.call(message, "playing")
    )
      writer.uint32(/* id 2, wireType 0 =*/ 16).bool(message.playing);
    if (
      message.lastSyncTime != null &&
      Object.hasOwnProperty.call(message, "lastSyncTime")
    )
      writer.uint32(/* id 3, wireType 1 =*/ 25).double(message.lastSyncTime);
    if (
      message.lastSyncPosition != null &&
      Object.hasOwnProperty.call(message, "lastSyncPosition")
    )
      writer
        .uint32(/* id 4, wireType 1 =*/ 33)
        .double(message.lastSyncPosition);
    return writer;
  };
  ...
  SyncState.verify = function verify(message) {
    ...
    if (message.seqNo != null && message.hasOwnProperty("seqNo"))
      if (!$util.isInteger(message.seqNo)) return "seqNo: integer expected";
    ...
    if (
      message.lastSyncPosition != null &&
      message.hasOwnProperty("lastSyncPosition")
    )
  ...
  SyncState.fromObject = function fromObject(object) {
    if (object instanceof $root.SyncState) return object;
    var message = new $root.SyncState();
    if (object.seqNo != null) message.seqNo = object.seqNo | 0;
    if (object.playing != null) message.playing = Boolean(object.playing);
  ...
  SyncState.toObject = function toObject(message, options) {
    ...
    if (message.lastSyncTime != null && message.hasOwnProperty("lastSyncTime"))
      object.lastSyncTime =
        options.json && !isFinite(message.lastSyncTime)
          ? String(message.lastSyncTime)
          : message.lastSyncTime;
    if (
      message.lastSyncPosition != null &&
      message.hasOwnProperty("lastSyncPosition")
    )
      object.lastSyncPosition =
        options.json && !isFinite(message.lastSyncPosition)
          ? String(message.lastSyncPosition)
          : message.lastSyncPosition;
    return object;
  };
...
$root.SetSyncStateReq = (function () {
  ...
  SetSyncStateReq.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (
      message.newSyncState != null &&
      Object.hasOwnProperty.call(message, "newSyncState")
    )
      $root.SyncState.encode(
        message.newSyncState,
  ...
  SetSyncStateReq.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.SetSyncStateReq();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.newSyncState = $root.SyncState.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  SetSyncStateReq.verify = function verify(message) {
    ...
    if (
      message.newSyncState != null &&
      message.hasOwnProperty("newSyncState")
    ) {
      var error = $root.SyncState.verify(message.newSyncState);
      if (error) return "newSyncState." + error;
    }
    return null;
  };
  ...
  SetSyncStateReq.fromObject = function fromObject(object) {
    if (object instanceof $root.SetSyncStateReq) return object;
  ...
  SetSyncStateReq.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.newSyncState = null;
    if (message.newSyncState != null && message.hasOwnProperty("newSyncState"))
      object.newSyncState = $root.SyncState.toObject(
        message.newSyncState,
        options
      );
    return object;
...
$root.SetSyncStateResp = (function () {
  ...
  SetSyncStateResp.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.SetSyncStateResp();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  SetSyncStateResp.fromObject = function fromObject(object) {
    if (object instanceof $root.SetSyncStateResp) return object;
    ...
    if (message.status != null && message.hasOwnProperty("status"))
      object.status =
        options.enums === String
          ? $root.SetSyncStateResp.Status[message.status]
          : message.status;
    return object;
  };
...
$root.RequestResyncReq = (function () {
  ...
  RequestResyncReq.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (
      message.clientLatestSeqNo != null &&
      Object.hasOwnProperty.call(message, "clientLatestSeqNo")
    )
  ...
  RequestResyncReq.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.RequestResyncReq();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  RequestResyncReq.verify = function verify(message) {
    ...
    if (
      message.clientLatestSeqNo != null &&
      message.hasOwnProperty("clientLatestSeqNo")
    )
  ...
  RequestResyncReq.fromObject = function fromObject(object) {
    if (object instanceof $root.RequestResyncReq) return object;
  ...
  RequestResyncReq.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.clientLatestSeqNo = 0;
    if (
      message.clientLatestSeqNo != null &&
      message.hasOwnProperty("clientLatestSeqNo")
    )
