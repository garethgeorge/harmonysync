...
$root.VideoInfo = (function () {
  ...
  VideoInfo.fromObject = function fromObject(object) {
    if (object instanceof $root.VideoInfo) return object;
...
$root.RoomInfo = (function () {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          if (!(message.queue && message.queue.length)) message.queue = [];
  ...
  RoomInfo.verify = function verify(message) {
    ...
    if (message.queue != null && message.hasOwnProperty("queue")) {
      if (!Array.isArray(message.queue)) return "queue: array expected";
      for (var i = 0; i < message.queue.length; ++i) {
  ...
  RoomInfo.fromObject = function fromObject(object) {
    if (object instanceof $root.RoomInfo) return object;
  ...
  RoomInfo.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.queue = [];
    if (options.defaults) {
      if ($util.Long) {
...
$root.JoinRoomReq = (function () {
  ...
  JoinRoomReq.fromObject = function fromObject(object) {
    if (object instanceof $root.JoinRoomReq) return object;
...
$root.JoinRoomResp = (function () {
  ...
  JoinRoomResp.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (
      message.roomInfo != null &&
      Object.hasOwnProperty.call(message, "roomInfo")
    )
      $root.RoomInfo.encode(
        message.roomInfo,
  ...
  JoinRoomResp.verify = function verify(message) {
    ...
    if (message.roomInfo != null && message.hasOwnProperty("roomInfo")) {
      ...
      if (error) return "roomInfo." + error;
    }
    return null;
  };
  ...
  JoinRoomResp.fromObject = function fromObject(object) {
    if (object instanceof $root.JoinRoomResp) return object;
  ...
  JoinRoomResp.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.roomInfo = null;
    if (message.roomInfo != null && message.hasOwnProperty("roomInfo"))
