...
$root.SyncState = (function () {
   ...
   * @instance
   */
  SyncState.prototype.lastSyncTime = $util.Long
  ...
  SyncState.verify = function verify(message) {
    ...
    if (message.lastSyncTime != null && message.hasOwnProperty("lastSyncTime"))
      if (
        !$util.isInteger(message.lastSyncTime) &&
        !(
          message.lastSyncTime &&
          $util.isInteger(message.lastSyncTime.low) &&
          $util.isInteger(message.lastSyncTime.high)
        )
      )
  ...
  SyncState.fromObject = function fromObject(object) {
    ...
    if (object.lastSyncTime != null)
      if ($util.Long)
        (message.lastSyncTime = $util.Long.fromValue(
          object.lastSyncTime
        )).unsigned = false;
        ...
        message.lastSyncTime = new $util.LongBits(
          object.lastSyncTime.low >>> 0,
          object.lastSyncTime.high >>> 0
        ).toNumber();
  ...
  SyncState.toObject = function toObject(message, options) {
      ...
      if ($util.Long) {
        ...
        object.lastSyncTime =
          options.longs === String
            ...
            ? long.toNumber()
            : long;
      } else object.lastSyncTime = options.longs === String ? "0" : 0;
    ...
    if (message.lastSyncTime != null && message.hasOwnProperty("lastSyncTime"))
      if (typeof message.lastSyncTime === "number")
        ...
        object.lastSyncTime =
          options.longs === String
            ? $util.Long.prototype.toString.call(message.lastSyncTime)
            : options.longs === Number
            ? new $util.LongBits(
                message.lastSyncTime.low >>> 0,
                message.lastSyncTime.high >>> 0
              ).toNumber()
            : message.lastSyncTime;
    if (
      message.lastSyncPosition != null &&
